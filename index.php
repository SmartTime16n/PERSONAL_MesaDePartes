...
<head>
    ...
    <meta charset="utf-8">
    <title>Acceso | Banco Alimentos - Mesa de partes</title>
...
<body>
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="index-1.html" class="d-block auth-logo">
                                        <img src="assets/picture/logo-sm-1.svg" alt="" height="28"> <span class="logo-txt">Banco de alimentos</span>
                                    </a>
                                </div>
                                    ...
                                    <div class="mt-4 pt-2 text-center">
                                        ...
                                        <ul class="list-inline mb-0">
                                            ...
                                            <li class="list-inline-item">
                                                 <!--TODO: boton de iniciar sesion en Google con atributos de datos HTML para la API -->
                                                <div id="g_id_onload"
                                                ...
                                                >
                                                <!--TODO: Configuracion del boton de inicio de secion de google -->
                                                </div>
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">© <script>
                                        ...
                                        </script> Banco de alimentos . <i class="mdi mdi-heart text-danger"></i> </p>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item active">
                                                <div class="testi-contain text-white">
                                                    ...
                                                    <h4 class="mt-4 fw-medium lh-base text-white">“Una sociedad equitativa es posible,
                                                        pero se necesita de la ayuda de todos..”
                                                    </h4>
                                                    <div class="mt-4 pt-3 pb-5">
                                                        <div class="d-flex align-items-start">
                                                            ...
                                                            <div class="flex-grow-1 ms-3 mb-4">
                                                                <h5 class="font-size-18 text-white">Banco de alimentos
                                                                </h5>
                                                                <p class="mb-0 text-white-50">Bienestar social</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="carousel-item">
                                                <div class="testi-contain text-white">
                                                    ...
                                                    <h4 class="mt-4 fw-medium lh-base text-white">“Banco de Alimentos es el puente que une la abundancia con la carencia,
                                                        rescatando ese alimento.”</h4>
                                                    <div class="mt-4 pt-3 pb-5">
                                                        <div class="d-flex align-items-start">
                                                            <div class="flex-shrink-0">
                                            ...
                                            <div class="carousel-item">
                                                <div class="testi-contain text-white">
                                                    ...
                                                    <h4 class="mt-4 fw-medium lh-base text-white">“Apoyando nuestra organización evitas
                                                        el impacto ambiental que se generaría por el desperdicio.”</h4>
                                                    <div class="mt-4 pt-3 pb-5">
                                                        <div class="d-flex align-items-start">
                                                            <img src="assets/picture/avatar-3-1.jpg" class="avatar-md img-fluid rounded-circle" alt="...">
                                                            <div class="flex-1 ms-3 mb-4">
                                                                <h5 class="font-size-18 text-white">Banco de alimentos</h5>
                                                                <p class="mb-0 text-white-50">Bienestar social
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <!--TODO: Scrip para cargar la API de google Sing-in de manera asicrona -->
